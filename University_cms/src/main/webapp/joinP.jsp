...
<body>
	<div class="container">
		<div style="width: 50%; margin: auto; padding: 20px;">
			<form action="insert/professor" method="post">
			  <fieldset>
			    <legend>교수정보등록</legend>
			    <hr>
			    
			    <div class="form-group">
			      <label for="professor id">Professor Id</label>
			      <input type="text" class="form-control" id="pNum" name="pNum" aria-describedby="emailHelp" placeholder="Professor Id">
			      <small id="emailHelp" class="form-text text-muted">부여받은 교번을 입력해 주세요.</small>
			    </div>
			    ...
			    <div class="form-group">
			      ...
			      <input type="password" class="form-control" id="exampleInputPassword2" name="pPw" placeholder="Password Confirm">
			      <div class="valid-feedback"></div>
			    </div>
			    
			    <div class="form-group">
			      <label for="name">Name</label>
			      <input type="text" class="form-control" id="name" name="pName" placeholder="Name">
			    </div>
			    ...
			    <fieldset class="form-group">
			      ...
			      <div class="form-check">
			        <label class="form-check-label">
			          <input type="radio" class="form-check-input" name="pGender" id="optionsRadios1" value="male" checked="">
			          	Male
			        </label>
			      </div>
			      <div class="form-check">
			      <label class="form-check-label">
			          <input type="radio" class="form-check-input" name="pGender" id="optionsRadios2" value="female">
			          	Female
			        </label>
			      </div>
			    </fieldset>
			    ...
			    <div class="form-group">
			      ...
			      <input type="text" class="form-control" id="phone" name="pTel" placeholder="Phone Number">
			    </div>
			    
			    <div class="form-group">
			      <label for="email1">E-mail</label>
			      <input type="text" class="form-control" id="email" name="pEmail" placeholder="E-mail">
			    </div>
			    
			    <div class="form-group">
			      <label for="address">Address</label>
			      <input type="text" class="form-control" id="address" name="pAddr" placeholder="Address">
			    </div>
